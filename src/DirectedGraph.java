...
public class DirectedGraph<T extends Comparable<T>> {
     ...
     */
    public void setEdgeWeight(T from, T to, String weight){
     ...
     * @return  true only when the vertex was successfully added
     */
    public boolean addEdge(T from, T to, String weight){
        Vertex<T> f = null;
        Vertex<T> t = null;
    ...
    public static class Vertex <T extends Comparable<T>> implements Comparable<Vertex<T>> {
         ...
         * @param weight    the desired weight
         */
        public void addEdge(Vertex<T> to, String weight) {
            edgeList.addLast(new Edge<T>(this, to, weight));
        }
         ...
         * @param weight    the desired weight
         */
        public void setWeight(T data, String weight) {
         ...
         */
        public String getWeightTo(T data) {
    ...
    public static class Edge<T extends Comparable<T>> implements Comparable<Edge<T>> {
         ...
         */
        public Edge(Vertex<T> from, Vertex<T> to, String weight){
            this.from = from;
            this.to = to;
            this.weight = weight;
        }
